              ...
              <ListRow
                contents={
                  <ListRow.Texts
                    ...
                    bottom={formatCurrency(calculationResults?.expectedAmount || 0)}
              ...
              <ListRow
                contents={
                  <ListRow.Texts
                    ...
                    top="목표 금액과의 차이"
                    topProps={{ color: colors.grey600 }}
                    bottom={formatCurrency(calculationResults?.difference || 0)}
                    bottomProps={{ fontWeight: 'bold', color: colors.blue600 }}
                  />
                }
              />
              <ListRow
                contents={
                  <ListRow.Texts
                    ...
                    top="추천 월 납입 금액"
                    topProps={{ color: colors.grey600 }}
                    bottom={formatCurrency(calculationResults?.recommendedAmount || 0)}
                    bottomProps={{ fontWeight: 'bold', color: colors.blue600 }}
                  />
                }
              />
